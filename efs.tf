...
user_data = <<-EOF
      #! /bin/bash
       ...
       sudo git clone https://github.com/kranthi1234/aws-terraform.git /var/www/html
...
resource "aws_codepipeline" "codepipeline" {
  name     = "kranthi"
  role_arn = "arn:aws:iam::341111******:role/service-role/AWSCodePipelineServiceRole-ap-south-1-kranthi"
